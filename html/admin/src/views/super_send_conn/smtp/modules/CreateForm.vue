    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="邮件账号">
          <a-input v-decorator="['smtp_send_email', {rules: [{required: true, message: '邮件账号'}]}]" />
        </a-form-item>
        <a-form-item label="端口">
          <a-input v-decorator="['port', {rules: [{required: true, message: '端口'}]}]" />
        </a-form-item>
        <a-form-item label="smtp地址">
          <a-input v-decorator="['smtp_server', {rules: [{required: true, message: 'smtp地址'}]}]" />
        </a-form-item>
        <a-form-item label="smtp密码">
          <a-input-password v-decorator="['smtp_password', {rules: [{required: true, message: 'smtp密码'}]}]" />
        </a-form-item>
        <a-form-item label="最多并发数">
          <a-input v-decorator="['max_concurrency', {rules: [{required: true, message: '最多并发数'}]}]" />
        </a-form-item>
      </a-form>
    </a-spin>
  </a-modal>
...
const fields = ['id', 'title', 'smtp_send_email', 'port', 'max_concurrency', 'smtp_server', 'smtp_password']// 表单字段
export default {
  components: {
  },
  watch: {
